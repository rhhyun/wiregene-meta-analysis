...
seed_runtime_env_from_process() {
  for key in APP_BASIC_AUTH_USER APP_BASIC_AUTH_PASSWORD APP_BASIC_AUTH_USERS WIREGENE_ADMIN_EMAILS APP_ADMIN_USERS APP_ADMIN_USER OPENAI_API_KEY OPENAI_MODEL META_AI_SETTINGS_STORAGE_PATH META_AI_SETTINGS_SECRET; do
