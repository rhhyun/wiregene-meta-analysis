...
const metaFullTextScoringRules = [
  ...
  "Age is analysis-ready only when mean_age has at least one uncertainty or effect field when reported: mean_age_sd, mean_age_se, mean_age_ci_low/high, or mean_age_effect_or/CI/p. If only mean age is reported, keep the value but flag the missing SD/SE/CI/effect support.",
  "Playing time must be normalized to weekly hours. Preserve the original article value in playing_hours_original and playing_hours_original_unit, then set playing_hours_per_week using daily x 7, weekly unchanged, monthly x 12/52, yearly / 52; explain unclear conversions in playing_hours_conversion_rule.",
  "Code professional_status as 0=student/trainee, 1=professional, 2=mixed professional/student or mixed career status, 9=unclear/not reported, and keep the code definition.",
  "Use numeric code fields for categorical analysis parameters. Default specific_instrument_code is violin=0, viola=1, flute=2, oboe=3, cello=4, double bass=5, clarinet=6, bassoon=7, horn/brass=8, piano=9, guitar=10, other=98, mixed/unclear=99.",
  "Separate study-level and result-level extraction. RoB/publication-bias fields are study-level; outcome n/N, mean/SD, OR/SMD, subgroup comparison, and instrument/asymmetry comparison fields are result-level.",
  "For same-paper comparisons, keep study-level covariates on the same study row and encode each comparison with result_id, result_group_1/2 label/code, result_parameter_name/code, result_outcome_group, and result_effect_* fields instead of duplicating study-level facts.",
    ...
    "rows": [
      {
        ...
        "professional_status_code": "0=student/trainee; 1=professional; 2=mixed; 9=unclear",
        "professional_status_code_definition": "0=student/trainee; 1=professional; 2=mixed; 9=unclear/not reported",
        "professional_status_mixed_group_notes": "string",
        "mean_age": "string",
        "mean_age_sd": "string",
        "mean_age_se": "string",
        "mean_age_ci_low": "string",
        "mean_age_ci_high": "string",
        "mean_age_effect_or": "string",
        "mean_age_effect_ci_low": "string",
        "mean_age_effect_ci_high": "string",
        "mean_age_effect_p_value": "string",
        "mean_age_source_unit": "years or article unit",
        "female_percent": "string",
        "instrument_group_reported": "string",
        "specific_instrument": "string",
        "specific_instrument_code": "numeric code, or 99 for mixed/unclear",
        "specific_instrument_code_definition": "violin=0; viola=1; flute=2; oboe=3; cello=4; double bass=5; clarinet=6; bassoon=7; horn/brass=8; piano=9; guitar=10; other=98; mixed/unclear=99",
        "instrument_category_code": "numeric code",
        "instrument_category_code_definition": "0=upper strings; 1=lower strings; 2=woodwind; 3=brass; 4=keyboard; 5=plucked strings; 6=percussion; 9=mixed/unclear",
        "mapped_asymmetry_group": "string",
        "asymmetry_group_code": "0=low/mixed/orofacial/not classifiable; 1=moderate; 2=high; 9=unclear",
        "asymmetry_group_code_definition": "0=low/mixed/orofacial/not classifiable; 1=moderate/seated axial-load; 2=high asymmetry; 9=unclear",
        "mapping_confidence": "high|medium|low|unclear",
        "comparison_parameter_notes": "study-level vs result-level coding notes",
        "playing_hours": "string",
        "playing_hours_original": "string exactly as reported",
        "playing_hours_original_unit": "per day|per week|per month|per year|unclear",
        "playing_hours_per_week": "weekly normalized numeric value when calculable",
        "playing_hours_conversion_rule": "daily x7, weekly unchanged, monthly x12/52, yearly /52, or why blank",
        "years_experience": "string",
        "recall_window": "string",
        "pain_definition": "string",
        "prmd_definition": "string",
        "result_id": "stable result row id such as study_id:outcome:group",
        "result_level": "study|outcome|group|comparison",
        "result_group_1_label": "string",
        "result_group_1_code": "string",
        "result_group_2_label": "string",
        "result_group_2_code": "string",
        "result_parameter_name": "instrument|asymmetry_group|professional_status|playing_hours|age|other",
        "result_parameter_code": "numeric code for result comparison",
        "result_parameter_code_definition": "codes used for this result parameter",
        "result_outcome_group": "primary region/laterality outcome or secondary/narrative outcome",
        "result_effect_measure": "prevalence|OR|SMD|mean_difference|correlation|other",
        "result_effect_value": "string",
        "result_effect_ci_low": "string",
        "result_effect_ci_high": "string",
        "result_effect_standard_error": "string",
        "result_effect_p_value": "string",
        "neck_n": "string",
        "neck_total": "string",
