...
export const orchestralPainProject: MetaStudyProject = {
  ...
  extractionColumns: [
    ...
    "playing_hours_day",
    "playing_hours_week",
    "instrument_data_level",
    "instrument_group",
    "specific_instrument",
    "instrument_group_original",
    "instrument_group_harmonized",
    "asymmetry_class",
    "asymmetry_basis",
    "high_asymmetry_n",
    "moderate_asymmetry_n",
    "low_asymmetry_n",
    "mixed_or_unclear_n",
    "violin_viola_separable",
    "upper_lower_string_separable",
    "flute_separable",
    "brass_separable",
    "piano_separable",
    "percussion_separable",
    "PRMD_definition",
    "pain_definition",
    "recall_window",
    "overall_PRMD_n",
    "overall_PRMD_total",
    "overall_PRMD_percent",
    "current_pain_n",
    "current_pain_total",
    "lifetime_pain_n",
    "lifetime_pain_total",
    ...
    "left_shoulder_n",
    "left_shoulder_total",
    "left_shoulder_percent",
    "right_shoulder_n",
    "right_shoulder_total",
    "right_shoulder_percent",
    "shoulder_unspecified_n",
    "shoulder_unspecified_total",
    "shoulder_unspecified_percent",
    "left_elbow_forearm_n",
    "left_elbow_forearm_total",
    "left_elbow_forearm_percent",
    "right_elbow_forearm_n",
    "right_elbow_forearm_total",
    "right_elbow_forearm_percent",
    "left_wrist_hand_n",
    "left_wrist_hand_total",
    "left_wrist_hand_percent",
    "right_wrist_hand_n",
    "right_wrist_hand_total",
    "right_wrist_hand_percent",
    "upper_back_n",
    "upper_back_total",
    "upper_back_percent",
    "lower_back_n",
    ...
    "pain_intensity_mean",
    "pain_intensity_sd",
    "pain_intensity_median",
    "pain_intensity_iqr",
    "pain_interference_scale",
    "pain_interference_mean",
    "pain_interference_sd",
    "performance_limitation_n",
    "performance_limitation_total",
    "performance_limitation_percent",
    "stopped_playing_n",
    "sick_leave_n",
    "healthcare_consultation_n",
    "DASH_score_mean",
    "MPIIQM_intensity_score",
    "MPIIQM_interference_score",
