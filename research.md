...
- Nested Google Drive OAuth errors in API `details` payloads must be treated as recoverable storage-unavailable events, not shown to researchers as raw `operation/path/backend/message/help` diagnostics.
